...
/**
 * 资产管理系统信息对象 lgs_assets_system
 * 
 * @author lgn
 * @date 2022-08-11
 */
public class LgsAssetsSystem extends BaseEntity
{
    ...
    /** 类型;0：联网，1：本地 */
    @Excel(name = "类型;0：联网，1：本地")
    private Integer type;

    /** 状态:0:Production、1:Impmentation、2:Archive、3:EoL */
    @Excel(name = "状态")
    private Integer state;

    /** 是否gxp;0：是，1：否 */
    @Excel(name = "是否gxp;0：是，1：否")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("isGxp", getIsGxp())
            .append("coreServices", getCoreServices())
